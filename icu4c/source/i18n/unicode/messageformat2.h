...
namespace message2 {
    ...
    private:
        ...
        void matchSelectorKeys(Environment&,
                               const UVector&, MessageContext&, InternalValue&& rv, UVector&, UErrorCode&) const;
        // Takes a vector of FormattedPlaceholders (input),
        // and a vector of vectors of strings (output)
        void resolvePreferences(Environment&, MessageContext&, UVector&, UVector&, UErrorCode&) const;
